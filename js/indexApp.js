var myindexApp = angular.module('myindexApp',['ngRoute', 'ngAnimate', 'ui.bootstrap', 'slick', 'angularModalService']);
myindexApp.controller('indexController', ['$scope', '$http', '$interval', 'ModalService', function($scope,$http,$interval,ModalService){


  //Display title modal star rating


  //Display title listings
  $scope.movies;
  ...
  $scope.openMovInfo = function(movie){

    //modal service
    ModalService.showModal({
        templateUrl: 'movieModal.html',
        controller: 'IndexModalMVController',
        scope: $scope,
        inputs: {
          displaymovie: movie
        }
...
$scope.openTvInfo = function(shows) {
  ModalService.showModal({
      templateUrl: 'tvModal.html',
      controller: 'IndexModalTVController',
      scope: $scope,
      inputs: {
        displaytv: shows
      }
...
myindexApp.controller('IndexModalMVController', ['$scope', 'displaymovie', 'close', function($scope, displaymovie,close) {
...
myindexApp.controller('IndexModalTVController', ['$scope', 'displaytv', 'close', function($scope, displaytv,close) {

   $scope.displaytv = displaytv;
   $scope.close = function(result) {
    close(result, 500); // close and give 500ms for bootstrap to animate
   };
